...
interface IconProps {
  name: 'logger' | 'planner' | 'camera' | 'delete' | 'leftArrow' | 'rightArrow' | 'sparkles' | 'dumbbell' | 'edit' | 'mic';
  className?: string;
}
...
const icons: { [key in IconProps['name']]: JSX.Element } = {
  ...
  dumbbell: (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      ...
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 6.327V17.673M6.327 12H17.673M2 12h1.5M20.5 12H22M12 2v1.5M12 20.5V22M4.929 4.929l1.06 1.06M18.01 18.01l1.061 1.061M4.929 19.071l1.06-1.06M18.01 5.99l1.061-1.061" />
    </svg>
  ),
  edit: (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
